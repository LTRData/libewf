     ...
     void )
{
	...
	destination_hash_sections = (libewf_hash_sections_t *) 0x12345678UL;
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libewf_hash_sections_clone with malloc failing
		 */
		ewf_test_malloc_attempts_before_fail = test_number;
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libewf_hash_sections_clone with memcpy failing
		 */
