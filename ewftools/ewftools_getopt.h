...
#if !defined( _EWFTOOLS_GETOPT_H )
#define _EWFTOOLS_GETOPT_H
...
#define ewftools_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t ewftools_getopt(
                  int argument_count,
...
#endif /* !defined( _EWFTOOLS_GETOPT_H ) */
