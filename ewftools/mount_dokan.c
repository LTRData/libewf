...
NTSTATUS __stdcall mount_dokan_ZwCreateFile(
                    const wchar_t *path,
                    DOKAN_IO_SECURITY_CONTEXT *security_context EWFTOOLS_ATTRIBUTE_UNUSED,
                    ACCESS_MASK desired_access,
                    ULONG file_attributes EWFTOOLS_ATTRIBUTE_UNUSED,
                    ULONG share_access EWFTOOLS_ATTRIBUTE_UNUSED,
                    ULONG creation_disposition,
                    ULONG creation_options EWFTOOLS_ATTRIBUTE_UNUSED,
                    DOKAN_FILE_INFO *file_info )
{
	libcerror_error_t *error = NULL;
	...
	EWFTOOLS_UNREFERENCED_PARAMETER( security_context )
	EWFTOOLS_UNREFERENCED_PARAMETER( file_attributes )
	EWFTOOLS_UNREFERENCED_PARAMETER( share_access )
	EWFTOOLS_UNREFERENCED_PARAMETER( creation_options )
