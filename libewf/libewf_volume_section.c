         ...
         libcerror_error_t **error )
{
	...
	static char *function    = "libewf_volume_section_e01_read";
         ...
         libcerror_error_t **error )
{
	...
	static char *function        = "libewf_volume_section_e01_write";
...
{
	uint8_t *section_data    = NULL;
	static char *function    = "libewf_volume_section_s01_read";
	size_t section_data_size = 0;
	ssize_t read_count       = 0;
         ...
         libcerror_error_t **error )
{
	...
	static char *function        = "libewf_volume_section_s01_write";
	ssize_t total_write_count    = 0;
	ssize_t write_count          = 0;
	uint32_t calculated_checksum = 0;
